 ...
 * @author drlias
 */
public class FSecretaria extends javax.swing.JFrame {
    ...
    public FSecretaria() {
        ...
        //adaptar para nuestro
//        if(cnx.conectar("localhost", "escolar", "root", "")==1){
//            JOptionPane.showMessageDialog(this, "conectado buenos dias");
//            cnx.entablar("SELECT * FROM alumnos ORDER BY codigo DESC", TEstudiantes);
//        }else{
//            JOptionPane.showMessageDialog(this, "pipipi");
//            System.exit(0);
//        }
    }
    ...
    private void initComponents() {
        ...
        SCreditos.setModel(new javax.swing.SpinnerNumberModel(0, 0, null, 1));
    ...
    private void bRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRegistrarActionPerformed
        ...
        String car = TCarrera.getText();
        String eda = SEdad.getValue().toString();
        String cre = SCreditos.getValue().toString();
        String est = CBEstatus.getSelectedItem().toString();
        String sex = CBSexo.getSelectedItem().toString();
        
        //Paso 2. Crear un objeto con los datos
        Alumno aa = new Alumno(cod, nom, car, eda, cre, est, sex);
    ...
    private void TEstudiantesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TEstudiantesMousePressed
        ...
        if (renglon!=-1) {
            TCodigo.setText(datos.getValueAt(renglon, 0).toString());
            TNombre.setText(datos.getValueAt(renglon, 1).toString());
            TCarrera.setText(datos.getValueAt(renglon, 2).toString());
            SEdad.setValue(Integer.valueOf(datos.getValueAt(renglon, 3).toString()));
            SCreditos.setValue(Integer.valueOf(datos.getValueAt(renglon, 4).toString()));
            CBEstatus.setSelectedItem(datos.getValueAt(renglon, 5));
            CBSexo.setSelectedItem(datos.getValueAt(renglon, 6));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FSecretaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FSecretaria().setVisible(true);
            }
        });
    }
